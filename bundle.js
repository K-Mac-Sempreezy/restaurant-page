...
/***/ "./dist/imgs/fruit-stand.png":
/*!***********************************!*\
  !*** ./dist/imgs/fruit-stand.png ***!
  \***********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "3af5d27562be838f74e8.png";
...
/* harmony import */ var _imgs_fruit_stand_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./imgs/fruit-stand.png */ "./dist/imgs/fruit-stand.png");
/* harmony import */ var _svg_github_icon_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./svg/github-icon.svg */ "./dist/svg/github-icon.svg");
// Imports
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(_fonts_UnicaOne_Regular_ttf__WEBPACK_IMPORTED_MODULE_3__);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(_fonts_Montserrat_Regular_ttf__WEBPACK_IMPORTED_MODULE_4__);
var ___CSS_LOADER_URL_REPLACEMENT_2___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(_fonts_Montserrat_Bold_ttf__WEBPACK_IMPORTED_MODULE_5__);
...
const createAbout = (e) => {
  ...
  (0,_home__WEBPACK_IMPORTED_MODULE_0__.resetPage)(e)
};
...
const resetPage = (e) => {
  ...
  (0,_nav__WEBPACK_IMPORTED_MODULE_0__.updateNav)(e);
};
...
const createFooter = () => {
  ...
  home.addEventListener('click', _home__WEBPACK_IMPORTED_MODULE_4__.resetPage);
  home.textContent = 'home';
  
  const menu = document.createElement('p');
  menu.setAttribute('id', 'footer-nav-menu');
  menu.addEventListener('click', _menu__WEBPACK_IMPORTED_MODULE_2__.createMenu);
  menu.textContent = 'menu';
  
  const about = document.createElement('p');
  about.setAttribute('id', 'footer-nav-about');
  about.addEventListener('click', _about__WEBPACK_IMPORTED_MODULE_3__.createAbout);
...
const createNav = () => {
  ...
  home.addEventListener('click', _home__WEBPACK_IMPORTED_MODULE_2__.resetPage);
  
  const menu = document.createElement('h4');
  menu.textContent = 'menu'.toUpperCase();
  menu.setAttribute('id', 'nav-menu');
  menu.addEventListener('click', _menu__WEBPACK_IMPORTED_MODULE_0__.createMenu);
  
  const about = document.createElement('h4');
  about.textContent = 'about'.toUpperCase();
  about.setAttribute('id', 'nav-about');
  about.addEventListener('click', _about__WEBPACK_IMPORTED_MODULE_1__.createAbout)
